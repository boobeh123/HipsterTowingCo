...
router.post('/inspections/count', counterLimiter, homeController.postInspectionCount)
...
router.post('/forgot', passwordResetLimiter, passwordResetController.postPasswordReset)
router.get('/reset/:token', passwordResetController.getRecoverPassword)
router.post('/reset/:token', passwordResetLimiter, passwordResetController.postRecoverPassword)
