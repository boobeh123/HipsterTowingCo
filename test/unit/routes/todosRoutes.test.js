...
jest.mock('../../../controllers/todos', () => ({
  getTodos: jest.fn((req, res) => res.json({ message: 'Todos page' })),
  getMoreInspections: jest.fn((req, res) => res.json({ inspections: [] })),
  ...
  searchTodos: jest.fn((req, res) => res.json({ inspections: [] })),
  viewInspection: jest.fn((req, res) => res.json({ message: 'View inspection' }))
}));
